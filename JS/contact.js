...
const init = function () {
    ...
    updateList(); //write the contacts on the screen
...
const addContact = function (ev) {
    //take from form, save in the object, add object to contacts array
    //replace localStorage with new contacts array
    ev.preventDefault();
    let obj = {};
    ...
    if (fullname && email && phone) {
        ...
        //better as a non-model div that removes itself
...
const removeContact = function (ev) {
    //get the data-key
    //find the matching email address in gloabal contacts 
    //remove that obj from the new contacts array
    ev.preventDefault();
